<?php
	...
	if (isset($_POST['login'])) { 
		$pass = ($_POST['password']); 
		$sql = mysqli_query($con, "SELECT * FROM tb_petugas WHERE username = '$_POST[username]' && password = '$pass'"); 
        ...
        if($cek > 0){ 
			...
			echo "<script>alert('Selamat Datang Admin ".$_SESSION['namanya']."'); document.location.href='admin/menu.php';</script>"; 
        } else {
			echo "<script>alert('Gagal Login'); document.location.href='adminLogin.php';</script>"; 
		}
    }
?>
<!DOCTYPE html>
